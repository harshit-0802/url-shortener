...
type ShortenUrlJSONRequestBody = ShortenRequest
...
type ServerInterface interface {
	...
	// (GET /{code})
	RedirectUrl(w http.ResponseWriter, r *http.Request, code string)
}
...
// Shorten a long URL
// (POST /shorten)
func (_ Unimplemented) ShortenUrl(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Redirect to the original URL
// (GET /{code})
func (_ Unimplemented) RedirectUrl(w http.ResponseWriter, r *http.Request, code string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) RedirectUrl(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RedirectUrl(w, r, code)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/{code}", wrapper.RedirectUrl)
	})
